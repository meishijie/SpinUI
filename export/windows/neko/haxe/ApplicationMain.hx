...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("", "TestCode", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "TestCode";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "TestCode", null, { width: 480, height: 640 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 480, height: 640 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 480, 640, "null");
		#end
		#else
		create ();
		#end
